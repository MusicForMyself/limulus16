...
// POST THUMBNAILS SUPPORT ///////////////////////////////////////////////////////////
	...
	if ( function_exists('add_image_size') ){
		...
		add_image_size( 'mid_lim', 519, 400, true );
...
// REMOVE P TAGS FROM IMAGES INSIDE POST CONTENT ///////////////////////////////////

	

	function filter_emtags_on_images($content){
   		return preg_replace('/<em>\s*(<a .*>)?\s*(<img .* \/>)\s*(<\/a>)?\s*<\/em>/iU', '\1\2\3', $content);
	}

	add_filter('the_content', 'filter_emtags_on_images');
